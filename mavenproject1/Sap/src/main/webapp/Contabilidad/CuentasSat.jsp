...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="panel panel-default">
              <div class="panel-body">
                ...
                <table class="tabla">
                	<tr>
                    	<td>
                    		<a href="AgregarCuentaContable.jsp">Agregar Cuenta Contable</a>
                        </td>
                    </tr>
                	<tr>
                    	<td>
                    		<a href="EliminarCuentaContable.jsp">Eliminar Cuenta Contable</a>
                        </td>
                    </tr>
                </table>
              </div>
        ...
        <div class="col-xs-6 col-md-6 central table-responsive">   
                    <h1 class="titulo">Cuentas Actuales en la Empresa</h1>
